...
def get_args():
    arg_0 = rand_strided((3, 2048), (2049, 1), device='cuda:0', dtype=torch.int64)
    arg_1 = rand_strided((1048576, 128), (128, 1), device='cuda:0', dtype=torch.float16)
    arg_2 = rand_strided((2048, 64), (64, 1), device='cuda:0', dtype=torch.float16)
