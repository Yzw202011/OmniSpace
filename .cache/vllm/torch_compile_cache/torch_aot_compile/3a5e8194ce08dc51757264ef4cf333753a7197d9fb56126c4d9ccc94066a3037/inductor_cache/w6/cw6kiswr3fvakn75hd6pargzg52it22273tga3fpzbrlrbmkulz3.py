...
# kernel path: E:\OmniSpace\.cache\vllm\torch_compile_cache\torch_aot_compile\3a5e8194ce08dc51757264ef4cf333753a7197d9fb56126c4d9ccc94066a3037\inductor_cache\tk\ctkgdzwsdir5gwrb3oerwwpoxrdatq4r5b4h72wdjpxsvyne62y6.py
# Topologically Sorted Source Nodes: [fused_add_rms_norm_maybe_inplace, add, fused_add_rms_norm_maybe_inplace_1, marlin_gemm_3], Original ATen: [vllm_ir.fused_add_rms_norm, aten.add, _C.marlin_gemm]
# Source node to ATen node mapping:
#   add => add_49
...
#   %arg23_1 : Tensor "f16[s18, 4096][4096, 1]cuda:0" = PlaceHolder[target=arg23_1]
#   %marlin_gemm : Tensor "f16[s18, 4096][4096, 1]cuda:0" = PlaceHolder[target=marlin_gemm]
#   %arg10_1 : Tensor "f16[s18, 4096][4096, 1]cuda:0" = PlaceHolder[target=arg10_1]
#   %buf10 : Tensor "f32[s18, 1][1, s18]cuda:0" = PlaceHolder[target=buf10]
#   %arg24_1 : Tensor "f16[4096][1]cuda:0" = PlaceHolder[target=arg24_1]
#   %convert_element_type_default_8 : Tensor "f32[s18, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%marlin_gemm, torch.float32), kwargs = {})
#   %convert_element_type_default_9 : Tensor "f32[s18, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg10_1, torch.float32), kwargs = {})
#   %add_tensor_4 : Tensor "f32[s18, 4096][4096, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_default_8, %convert_element_type_default_9), kwargs = {})
...
#   %add_49 : Tensor "f16[s18, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%marlin_gemm_2, %arg23_1), kwargs = {})
#   %convert_element_type_default_4 : Tensor "f32[s18, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_49, torch.float32), kwargs = {})
...
#   %mul_tensor_5 : Tensor "f16[s18, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_default_7, %arg24_1), kwargs = {})
#   %marlin_gemm_3 : Tensor "f16[s18, 6144][6144, 1]cuda:0"[num_users=1] = call_function[target=torch.ops._C.marlin_gemm.default](args = (%mul_tensor_5, None, %arg25_1, None, %arg26_1, None, None, %arg27_1, %arg28_1, %arg29_1, %arg30_1, 1125899907892224, %arg8_1, 6144, 4096, True, False, True, False), kwargs = {})
#   return %buf10,%convert_element_type_default_6,%buf11
triton_red_fused_add_fused_add_rms_norm_marlin_gemm_2 = async_compile.triton('triton_red_fused_add_fused_add_rms_norm_marlin_gemm_2', '''
import triton
import triton.language as tl
...
@triton_heuristics.reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp16', 'in_ptr1': '*fp16', 'in_ptr2': '*fp16', 'in_ptr3': '*fp16', 'in_ptr4': '*fp16', 'out_ptr1': '*fp16', 'out_ptr2': '*fp16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=70, cc=120, major=12, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_fused_add_rms_norm_marlin_gemm_2', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'atomic_add_found': False, 'num_load': 9, 'num_store': 2, 'num_reduction': 1, 'backend_hash': '0FAAA06D6C84A67843966AD4F2C5298301B3561B4A3D42D12213CFCD68515431', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False, 'add_persistent_rblock': True, 'tiling_scores': {'x': 0, 'r0_': 134225920}}
)
@triton.jit
def triton_red_fused_add_fused_add_rms_norm_marlin_gemm_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    r0_numel = 4096
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
    xoffset = tl.program_id(0) * XBLOCK
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
        ...
        tmp23 = tl.load(in_ptr3 + (r0_1 + 4096*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tmp28 = tmp20 + tmp27
        tmp29 = tl.full([1, 1], 4096.0, tl.float32)
        tmp30 = (tmp14 / tmp29)
        ...
        tmp37 = tmp35 * tmp36
        tl.store(out_ptr2 + (r0_1 + 4096*x0), tmp37, r0_mask & xmask)
''', device_str='cuda')
...
# Graph fragment:
#   %arg34_1 : Tensor "i64[3, s18][s7, 1]cuda:0" = PlaceHolder[target=arg34_1]
#   %arg33_1 : Tensor "f16[1048576, 128][128, 1]cuda:0" = PlaceHolder[target=arg33_1]
#   %index : Tensor "f16[3, s18, 128][128*s18, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg33_1, [%arg34_1]), kwargs = {})
...
arg23_1 = generate_example_value((2048, 4096), (4096, 1), 'cuda:0', torch.float16, 0, (2048, 4096))
arg24_1 = generate_example_value((4096,), (1,), 'cuda:0', torch.float16, 0, (4096,))
...
with torch.cuda._DeviceGuard(0):
    triton_red_fused_add_fused_add_rms_norm_marlin_gemm_2.run(buf8, arg23_1, buf1, arg10_1, arg24_1, buf9, buf11, 2048, 4096, stream=stream0)
del buf1, arg10_1, buf8, arg23_1, arg24_1, buf9, buf11
...
stream0 = get_raw_stream(0)
arg34_1 = generate_example_value((3, 2048), (2049, 1), 'cuda:0', torch.int64, 0, (3, 2048))
arg33_1 = generate_example_value((1048576, 128), (128, 1), 'cuda:0', torch.float16, 0, (1048576, 128))
...
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_clone_copy_index_select_slice_split_4.run(arg34_1, arg33_1, buf16, buf17, 2049, 2048, 64, stream=stream0)
del arg34_1, arg33_1

stream0 = get_raw_stream(0)
arg32_1 = generate_example_value((128,), (1,), 'cuda:0', torch.float16, 0, (128,))
...
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_5.run(buf13, buf15, arg32_1, buf16, buf17, buf14, arg31_1, buf18, buf19, buf21, buf22, 1048576, 4194304, stream=stream0)
del buf13, buf14, buf15, buf16, buf17, arg32_1, arg31_1, buf18, buf19, buf21, buf22
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [fused_add_rms_norm_maybe_inplace, add, fused_add_rms_norm_maybe_inplace_1, marlin_gemm_3], Original ATen: [vllm_ir.fused_add_rms_norm, aten.add, _C.marlin_gemm]
            stream0 = get_raw_stream(0)
            triton_red_fused_add_fused_add_rms_norm_marlin_gemm_2.run(buf8, arg23_1, buf1, arg10_1, arg24_1, buf9, buf11, s18, 4096, stream=stream0)
            del arg10_1
            del arg23_1
            del arg24_1
            del buf1
            # Topologically Sorted Source Nodes: [fused_add_rms_norm_maybe_inplace, add, fused_add_rms_norm_maybe_inplace_1, marlin_gemm_3], Original ATen: [vllm_ir.fused_add_rms_norm, aten.add, _C.marlin_gemm]
            buf12 = torch.ops._C.marlin_gemm.default(buf11, None, arg25_1, None, arg26_1, None, None, arg27_1, arg28_1, arg29_1, arg30_1, 1125899907892224, s18, 6144, 4096, True, False, True, False)
            del arg25_1
            del arg26_1
            del arg27_1
            del arg28_1
            ...
            # Topologically Sorted Source Nodes: [getitem_9, chunk, getitem_12, clone, setitem, getitem_13, setitem_1, getitem_14, getitem_15, clone_1, setitem_2, getitem_16, setitem_3, getitem_17], Original ATen: [aten.index, aten.split, aten.select, aten.clone, aten.slice, aten.copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused_clone_copy_index_select_slice_split_4.run(arg34_1, arg33_1, buf16, buf17, s7, s18, 64, stream=stream0)
            del arg33_1
            del arg34_1
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_5.run(buf13, buf15, arg32_1, buf16, buf17, buf14, arg31_1, buf18, buf19, buf21, buf22, triton_poi_fused_5_xnumel_0, triton_poi_fused_5_xnumel_1, stream=stream0)
            del arg31_1
            del arg32_1
            del buf14
            del buf15
...
def get_args():
    ...
    arg23_1 = rand_strided((2048, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg24_1 = rand_strided((4096, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg25_1 = rand_strided((256, 12288), (12288, 1), device='cuda:0', dtype=torch.int32)
    arg26_1 = rand_strided((128, 6144), (6144, 1), device='cuda:0', dtype=torch.float16)
    arg27_1 = rand_strided((0, ), (1, ), device='cuda:0', dtype=torch.int32)
    arg28_1 = rand_strided((0, ), (1, ), device='cuda:0', dtype=torch.int32)
    arg29_1 = rand_strided((0, ), (1, ), device='cuda:0', dtype=torch.int32)
    arg30_1 = rand_strided((70, ), (1, ), device='cuda:0', dtype=torch.int32)
    arg31_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg32_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg33_1 = rand_strided((1048576, 128), (128, 1), device='cuda:0', dtype=torch.float16)
    arg34_1 = rand_strided((3, 2048), (2049, 1), device='cuda:0', dtype=torch.int64)
    arg35_1 = 2049
    return [arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, arg10_1, arg11_1, arg12_1, arg13_1, arg14_1, arg15_1, arg16_1, arg17_1, arg18_1, arg19_1, arg20_1, arg21_1, arg22_1, arg23_1, arg24_1, arg25_1, arg26_1, arg27_1, arg28_1, arg29_1, arg30_1, arg31_1, arg32_1, arg33_1, arg34_1, arg35_1]
