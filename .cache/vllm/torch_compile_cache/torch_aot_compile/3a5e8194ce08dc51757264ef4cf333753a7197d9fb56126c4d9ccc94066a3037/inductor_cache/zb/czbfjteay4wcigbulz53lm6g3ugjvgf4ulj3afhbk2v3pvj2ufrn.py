...
def get_args():
    ...
    arg_5 = rand_strided((2048, 8, 64), (1024, 128, 1), device='cuda:0', dtype=torch.float16)
    arg_6 = rand_strided((2048, 8, 64), (1024, 128, 1), device='cuda:0', dtype=torch.float16)
