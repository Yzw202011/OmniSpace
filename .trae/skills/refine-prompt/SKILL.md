...
name: refine-prompt
class: meta
description: Transforms vague prompts into precise, structured AI instructions. Use when asked to refine, improve, or sharpen a prompt, do prompt engineering, write a system prompt, or make AI instructions more effective.
---
...
- Length ratio within 0.75x-1.5x of the original (unless structural change justified)
- No invented constraints or assumptions not in the original

---

安装记录：2026-08-30 经 https://github.com/iliaal/ai-skills/blob/master/skills/refine-prompt/SKILL.md 逐字核验后落盘（git clone 网络受限，内容与上游 master 一致）。用途：漫剧 ai-describe 二遍精修工序的六要素方法论来源。
