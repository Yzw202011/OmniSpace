...
| 🏗️ **工程质量高** | ≈370 个 HTTP 端点（含别名）+ WebSocket 状态通道；pytest **1045 用例**（GPU 集成显式开关）/ vitest **101 用例** / 活后端 E2E 三层测试体系 |
...
| **测试** | pytest（1045 用例，GPU 集成显式开关）+ vitest（101 用例）+ 活后端 E2E 流程编排 |
