...
ENGINE_MODULES: dict[str, tuple[str, str, str]] = {
    "dialog": ("backend.services.inference.dialog_engine",
               "get_dialog_engine", "DialogEngine"),
    "language": ("backend.services.inference.dialog_engine",
                 "get_dialog_engine", "DialogEngine"),
    "omni": ("backend.services.inference.dialog_engine",
             "get_dialog_engine", "DialogEngine"),
    "paint": ("backend.services.inference.paint_engine",
              "get_paint_engine", "PaintEngine"),
    "vision": ("backend.services.inference.paint_engine",
               "get_paint_engine", "PaintEngine"),
    "image": ("backend.services.inference.paint_engine",
              "get_paint_engine", "PaintEngine"),
    "video": ("backend.services.inference.video_engine",
              "get_video_engine", "VideoEngine"),
    "video_gen": ("backend.services.inference.video_engine",
                  "get_video_engine", "VideoEngine"),
    "voice": ("backend.services.inference.voice_engine",
