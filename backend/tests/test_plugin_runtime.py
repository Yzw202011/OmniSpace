...
from backend.services.plugin_runtime import base as pr_base
from backend.services.plugin_runtime import loader as pr_loader
from backend.services.plugin_runtime import registry as pr_registry

REAL_PLUGIN_PY = ROOT_DIR / "plugin" / "video_making.py"
