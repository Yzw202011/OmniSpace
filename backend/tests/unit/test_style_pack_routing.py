...
from backend.api.manga.comic_asset import _ART_STYLE_ZH, _PRESET_STYLE_PACK
from backend.services.inference.gen_router import (
    DEFAULT_PACK,
    PACK_PRIORITY,
    STYLE_PACKS,
    detect_style,
...
def test_golden_seed_cards():
    seed = json.loads((_HERE.parents[2] / "data" / "art_styles_seed_final.json")
                      .read_text("utf-8"))
