...
| `插件技能层接线方案-2026-09-17.md` | **技能插座层（已拍板执行，D1~D5 全 A，2026-09-17 当夜批0~批4 施工）** | 四创作功能（chat/novel/comic/manga）× 插件系统；manifest.skills 声明 + GET /plugins/skills 索引 + 每功能一个专用端点；安全全复用（三道闸/信任三档/沙箱）；出厂技能面为空（D3=A 插座先行） |
