...
> **2026-09-18 批3 复核**：静态实测 **356 装饰器 + 4 WS**（四轮审计口径，死端点复核=硬死仅 4/356=1.1%、仅测试消费 79、正常消费 76.7%——历史"40% 水分"口径失效）；期间增量=plugins 技能插座 3 端点/training 聚合 1/character_lora 6/训练中心与安全盾。全表重生成仍待工具补档。
>
