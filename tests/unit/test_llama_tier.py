...
class TestRouting:
    def test_detect_backend_gguf_dir_is_llama(self, tmp_path: Path) -> None:
        ...
        from src.services.inference.dialog_engine import _detect_backend
    ...
    def test_create_backend_llama(self) -> None:
        from src.services.inference.backends import create_backend
        from src.services.inference.backends.llama_backend import (
            LlamaServerBackend,
        )
...
class TestLlamaServiceGates:
    ...
    def test_missing_weights_rejected(self) -> None:
        from src.engines.llama_service import LlamaService
    ...
    def test_missing_runtime_rejected(
        ...
        from src.engines import llama_service as ls
    ...
    def test_admission_rejects_low_free(
        ...
        monkeypatch.setattr(
            "src.services.inference.gpu_budget.read_physical_bytes",
