...
from src.services.model_manager.importer import ModelImporter
...
def test_merged_models_external_import_visible(client, tmp_path):
    ...
    from src.api.models import _merged_models
...
def test_imported_dialog_models_vl_dir(isolated_db, tmp_path):
    ...
    from src.services.inference.dialog_engine import imported_dialog_models
...
def test_imported_paint_models_family_gate(isolated_db, tmp_path):
    ...
    from src.services.inference.paint_engine import imported_paint_models
...
def test_is_vllm_model_external_awq(isolated_db, tmp_path):
    ...
    from src.services.switch_engine import _is_vllm_model
