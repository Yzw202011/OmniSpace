...
from src.engines.vllm_service import _estimate_model_dir_gb  # noqa: E402
from src.services.vram_policy import VLLM_RAM_HEADROOM_GB  # noqa: E402

VLLM_PY = (Path(__file__).resolve().parents[2] / "src" / "engines" / "vllm_service.py")
...
def test_estimate_model_dir_gb_floor_and_cache(tmp_path) -> None:
    ...
    from src.engines.vllm_service import _DIR_SIZE_CACHE
...
def test_adopted_state_is_running_and_stop_safe():
    ...
    from src.engines.vllm_service import VLLMService
