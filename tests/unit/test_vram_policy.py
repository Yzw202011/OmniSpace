...
def test_policy_values_locked_to_history() -> None:
    ...
    from src.services import vram_policy as vp
...
def test_vllm_ram_needed_formula() -> None:
    from src.services.vram_policy import vllm_ram_needed_gb
...
def test_consumers_alias_single_source() -> None:
    ...
    from src.services import vram_policy as vp
    from src.services.inference import gen_router, paint_engine
