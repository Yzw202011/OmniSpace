...
def _fake_lock(monkeypatch: MonkeyPatch, active: str | None) -> None:
    ...
    monkeypatch.setattr(
        "src.middleware.feature_lock.get_feature_lock",
...
class TestDebouncedWake:
    ...
    def test_default_wake_calls_vllm(self, monkeypatch: MonkeyPatch) -> None:
        ...
        calls: list[int] = []
        monkeypatch.setattr(
            "src.engines.vllm_service.get_vllm_service",
    ...
    def test_best_effort_never_raises(self, monkeypatch: MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "src.engines.vllm_service.get_vllm_service", _boom)
        c = VramYieldCoordinator()
...
class TestComfyIdleExemption:
    ...
    @staticmethod
    def _mgr() -> object:
        from src.services.inference.comfy_proc import ComfyProcManager
