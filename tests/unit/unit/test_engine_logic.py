...
from src.data.models import detect_hardware_tier
from src.services.inference import dialog_engine, video_engine
from src.services.inference.paint_engine import PAINT_MODEL_CANDIDATES
...
def test_tier_no_gpu_falls_to_cpu():
    ...
    from src.data.models import HARDWARE_TIER_TABLE
